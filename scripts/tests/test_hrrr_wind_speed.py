#!/usr/bin/env python3
"""
Focused test for HRRR wind speed map generation.

Generates a single wind speed map with station overlays for HRRR.
"""
...
def test_hrrr_wind_speed():
    """Test HRRR wind speed map generation."""
    print("=" * 70)
    print("TEST: HRRR Wind Speed Map Generation")
    print("=" * 70)
    ...
    if not forecast_hours:
        raise ValueError("No forecast hours > 0 configured for wind speed test")
