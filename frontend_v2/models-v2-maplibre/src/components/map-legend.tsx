...
function UnavailablePlaceholder() {
  return (
    <div className="flex items-center gap-2 rounded-md border border-border/40 bg-[hsl(var(--toolbar))]/95 px-3 py-2.5 shadow-xl backdrop-blur-md">
...
export function MapLegend({ legend, onOpacityChange }: MapLegendProps) {
  ...
  return (
    <div
      className={cn(
        "fixed z-40 flex w-[280px] flex-col overflow-hidden rounded-md border border-border/50 bg-[hsl(var(--toolbar))]/95 shadow-xl backdrop-blur-md transition-all duration-200",
    ...
    >
      <button
        ...
        className="flex w-full items-center justify-between gap-2 border-b border-border/30 px-3 py-2 text-left transition-all duration-150 hover:bg-secondary/30 active:bg-secondary/50"
      ...
      >
        <div className="overflow-hidden">
          <div key={fadeKey} className="flex flex-col gap-2.5 px-3 py-2.5 animate-in fade-in duration-200">
              ...
              {legend.entries
                ...
                .map((entry, index) => (
                  <div
                    ...
                    className={cn(
                      "flex items-center gap-2.5 rounded-[2px] px-1.5 py-1 transition-colors duration-150",
                      index % 2 === 0 ? "bg-secondary/20" : "bg-transparent"
                    )}
                  >
                    <span
                      className="h-3 w-5 shrink-0 rounded-[2px] border border-border/30 shadow-sm"
